...
![Alt text for screen readers](https://github.com/AliciaSBa/AstrodynamicsEdu.jl/tree/main/docs/src/modules/LinearAlgebraTypes.png?raw=true "Linear Algebra Types Diagram")
