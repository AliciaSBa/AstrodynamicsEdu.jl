...
![Alt text for screen readers](https://raw.githubusercontent.com/AliciaSBa/AstrodynamicsEdu.jl/tree/main/docs/src/modules/LinearAlgebraTypes.png "Linear Algebra Types Diagram")
